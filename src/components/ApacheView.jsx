...
export default function ApacheView() {
  ...
  useEffect(() => {
    // Pedimos el files.json de la ubicación actual
    fetch("/files.json")
      .then((res) => res.json())
      ...
      <div className="overflow-x-auto">
        <table className="w-full text-left text-sm">
          ...
          <tbody className="text-green-800 font-medium">
            ...
            {/* Mapeo de archivos dinámico */}
            {files.map((file, i) => {
              // Verificamos si es una carpeta según el JSON
                ...
                >
                  <td className="py-3 px-2">
                    <a 
                      ...
                      {...(!isDir && { download: true })} // Solo descarga si NO es carpeta
